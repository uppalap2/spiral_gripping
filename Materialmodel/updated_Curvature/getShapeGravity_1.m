function [initial_shape,lambda1] = getShapeGravity_1(pressure, alpha , beta,fitmatFile,L,Eb,WpL, option)
...
curvature = (lambda1-1)/((lambda1+1)*Ro)  ;% the curvature updated wrt centerline
torsion = delta/L  ;


tic
                     
[~,~,initial_shape,~,~]  = getShape_1(curvature,... % e only for cons3 function
                       torsion,Eb,WpL,...
                       L,...
                       gravity_on,...
                       n_t_1,...
